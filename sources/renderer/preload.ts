...
// with "1"/"0"), not a runtime browser global — hence the no-undef disable. Kept on
// its own line so the disable stays attached to it if the condition is reformatted.
// eslint-disable-next-line no-undef
const devHarnessEnabled = process.env.GLAZE_DEV_HARNESS === "1";

if (devHarnessEnabled && preloadURL.searchParams.get("glazeParityDefaultPendingStub") === "1") {
