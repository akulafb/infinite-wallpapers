...
// Primary-display aspect ratio, clamped and memoised. Reads Electron's `screen`
// lazily (it is only usable after app ready) so a not-yet-ready backend just
// degrades to the 16:9 default rather than throwing mid-search.
